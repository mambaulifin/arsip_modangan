...
function tambah($data)
{
	...
	if (isset($_POST['submit'])) {
			...
			$query = "INSERT INTO surat_pindah_keluar VALUES ('','$nama','$jk','$tempat','$tgl','$status','$agama','$pekerjaan','$nik','$almt_asal','$tujuan','$tgl_pndh','$alasan','$foto')";
...
function hapus($id){
	global $conn;
	mysqli_query($conn, "DELETE FROM surat_pindah_keluar WHERE id_klr = $id");
	return mysqli_affected_rows($conn);
}
...
function edit($data){
	...
	$query = " UPDATE surat_pindah_keluar SET 
				nama = '$nama',
				jk = '$jk',
				tempat = '$tempat',
				tgl = '$tgl',
