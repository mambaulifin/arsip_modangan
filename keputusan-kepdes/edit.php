...
$id = $_GET["id"];
$edit = query("SELECT * FROM keputusan_kepdes WHERE id_k = $id")[0];
?>
...
<head>
    ...
    <title>Edit Data Keputusan Kepala Desa</title>
            ...
            <div class="content-header">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 font-weight-bold badge badge-dark border"> Edit Data keputusan Kepala Desa</h1>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        <input type="hidden" name="id" value="<?= $edit["id_k"]; ?>">
