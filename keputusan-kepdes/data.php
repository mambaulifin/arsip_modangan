...
$data_smsk = query("SELECT * FROM keputusan_kepdes ORDER BY id_k DESC");
?>
<!DOCTYPE html>
<html lang="en">
         ...
         <div class="content-header">
            <section class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="font-weight-bold badge badge-dark border">Data Keputusan Kepala Desa</h1>
                     </div>
                  </div>
               </div>
            </section>
                              ...
                              <td>
                                 <div class="d-flex justify-content-center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                       <a href="edit.php?id=<?= $key["id_k"]; ?>" class="text-white btn btn-primary btn-sm"><i class="fas fa-edit text-white"></i> Edit</a>
                                       <a href="hapus.php?id=<?= $key["id_k"]; ?>" class="text-white btn btn-warning btn-sm hapus"><i class="fa fa-trash-alt text-white"></i> Hapus</a>
