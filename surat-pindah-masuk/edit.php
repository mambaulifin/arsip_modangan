...
$id = $_GET["id"];
$edit = query("SELECT * FROM surat_pindah_masuk WHERE id_klr = $id")[0];
?>
...
<head>
    ...
    <title>Edit Data Surat Pindah Masuk</title>
            ...
            <div class="content-header">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 font-weight-bold badge badge-dark border"> Edit Data Surat Pindah Masuk <?= $edit['nama']; ?></h1>
                            </div>
                        </div>
                    </div>
                </section>
