         ...
         <div class="content-header">
            <section class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0 font-weight-bold badge badge-dark border"> Input Data Surat Keluar</h1>
                     </div>
                  </div>
               </div>
            </section>
               ...
               <form action="" method="post">
                  <table class="table text-dark">
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="no_surat" id="no_surat" class="form-control" value="-/-/409.19.9/12/2022" required></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="send" id="send" class="form-control" required></td>
                     </tr>
                     <tr>
